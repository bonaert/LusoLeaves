            ...
            <div class="col-lg-12">
                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        <strong><?php echo $this->lang->line("findUsName"); ?></strong>: Lusoleaves Unipessoal Lda
                    </li>
                    <li class="list-group-item">
                        <strong><?php echo $this->lang->line("findUsAddress"); ?></strong>: Estufa das Carapuças, Rogil,
                        Aljezur, PORTUGAL
                    </li>
                    <li class="list-group-item">
